...
#All of these look roughly the same. The transition with either ln or log10 does normalize the data. Again, will stick with log10 for consistency, particularly with CDC literature. 
...
ggplot(data=subset(All_Data, !is.na(All_Data$pos)), aes(x=ID, y=log10(as.numeric(Result_P_ng_mL)/as.numeric(Result_C_mg_dL))))+
  geom_jitter(aes(color=as.factor(pos), shape=as.factor(pos)), size=2)+
...
NHANES_Perch <- read_xpt("PERNT_J.XPT") #URXUP8 in ng/mL
NHANES_Demo <- read_xpt("DEMO_J.XPT")
NHANES_Creat <- read_xpt("ALB_CR_J.XPT") #UXRUCR in mg/dL
...
cor.test(log10(All_Data$Result_P_ng_mL), log10(All_Data$TSH), method = 'pearson')


All_Data_No_Meds <- subset(All_Data, All_Data$thyroid_med == 0)
cor.test(log10(All_Data_No_Meds$Result_P_ng_mL), log10(All_Data_No_Meds$TSH), method = 'pearson')
...
```{r corr_matrices}
df_corr_thyroid <- All_Data[ , c("Result_C_mg_dL","Result_C_ng_mL","Result_P_ng_mL","fT3","TSH","fT4","TotalT4","TotalT3","Cortisol","any_thyroid_problem_dummy","Hyper_D","Hypo_D","Thyroid_cancer_D","Goiter_D","pos","emr_thyroid_problem","emr_hyperthyroidism","emr_hypothyroidism","emr_thyroid_cancer","emr_goiter","EMR_any_thyroid_Dummy")]
...
df_corr_thyroid2 <- All_Data[ , c("Gender","Result_C_mg_dL","Result_C_ng_mL","Result_P_ng_mL","fT3","TSH","fT4","TotalT4","TotalT3","Cortisol","any_thyroid_problem_dummy","Hyper_D","Hypo_D","Thyroid_cancer_D","Goiter_D","pos","emr_thyroid_problem","emr_hyperthyroidism","emr_hypothyroidism","emr_thyroid_cancer","emr_goiter","EMR_any_thyroid_Dummy")]
...
model1_adj <- glm(Hypo_D ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all), data=All_Data, family="binomial")
summary(model1_adj)

model1_adj8 <- glm(Hypo_D ~ log(Result_P_ng_mL/Result_C_ng_mL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all), data=All_Data, family="binomial")
summary(model1_adj8)

#The CDC in their models just keep creatinine as a covariate, and so that's also what I will do, too.

#Quick checks
#model1_adj <- glm(SR_EMR_Hypothyroid ~ log(Result_P_ng_mL)*Water_all +log(Result_C_mg_dL) + Gender + Ethnicity + Site + age, data=(subset(All_Data, All_Data$Site!=1))) #No interaction with perchlorate and water.
...
model1_adj_NoCSF <- glm(Hypo_D ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + Site + + as.factor(Water_all), data=subset(All_Data, All_Data$Site!=1), family="binomial")
...
model2_adj <- glm(emr_hypothyroidism ~ log10(Result_P_ng_mL) + log10(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all), data=All_Data, family="binomial")
summary(model2_adj)
...
model3_adj <- glm(SR_EMR_Hypothyroid ~ log10(Result_P_ng_mL) +log10(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all), data=All_Data, family="binomial")
summary(model3_adj)
...
model3_adj_NoCSF <- glm(SR_EMR_Hypothyroid ~ log10(Result_P_ng_mL) +log10(Result_C_mg_dL) + Gender + age + Ethnicity + Site + as.factor(Water_all), data=subset(All_Data, All_Data$Site!=1), family="binomial")
...
test_model <- glm(SR_hypo_goit_canc ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all), data=subset(All_Data, All_Data$Site!=1), family="binomial")
summary(test_model)

#model3_adj <- glm(SR_hypo_goit_canc ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Gender*age + Ethnicity + Site + Water_all, data=All_Data)
#summary(model3_adj)
#exp(confint(model3_adj))
...
#model4_adj_withint <- glm(EMR_hypo_goit_canc ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Gender*age + Ethnicity + Site + Water_all, data=All_Data)
...
#model4_adj <- glm(EMR_hypo_goit_canc ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + Site + Water_all, data=All_Data)
#summary(model4_adj)
...
model1_adj <- glm(Hypo_D ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial")
summary(model1_adj)
exp(confint(model1_adj))
...
model1_adj_NoCSF <- glm(Hypo_D ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + Site + + as.factor(Water_all_revised), data=subset(All_Data, All_Data$Site!=1), family="binomial")
summary(model1_adj_NoCSF)
exp(confint(model1_adj_NoCSF))
...
model2_adj <- glm(emr_hypothyroidism ~ log10(Result_P_ng_mL) + log10(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial")
summary(model2_adj)
exp(confint(model2_adj))
...
model3_adj <- glm(SR_EMR_Hypothyroid ~ log10(Result_P_ng_mL) +log10(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial")
summary(model3_adj)
exp(confint(model3_adj))
...
model3_adj_NoCSF <- glm(SR_EMR_Hypothyroid ~ log10(Result_P_ng_mL) +log10(Result_C_mg_dL) + Gender + age + Ethnicity + Site + as.factor(Water_all_revised), data=subset(All_Data, All_Data$Site!=1), family="binomial")
summary(model3_adj_NoCSF)
exp(confint(model3_adj_NoCSF))
...
tiff("Perch_Dose2.tiff", units="in", width=15, height=5, res=300) #Only to save in high def.
...
model_adj1_sex_age <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender*age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial") 
summary(model_adj1_sex_age) #Checking gender and age interaction, does not meet threshold (p=0.254).

model_adj2_sex_age <- glm(emr_thyroid_problem_fromothercolumns ~ log10(Result_P_ng_mL) + log10(Result_C_mg_dL) + Gender*age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial")
summary(model_adj2_sex_age) #Checking gender and age interaction, does not meet threshold (p=0.697).

model_adj3_sex_age <- glm(any_thyroid_Dummy_EMR_or_SR ~ log10(Result_P_ng_mL) +log10(Result_C_mg_dL) + Gender*age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial")
summary(model_adj3_sex_age) #Checking gender and age interaction, does not meet threshold (p=0.911).


#Requested by reviewers (November 25, 2024):
#Checking gender and perchlorate exposure interaction
model_adj1_perch_sex <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL)*Gender + log(Result_C_mg_dL) + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial") 
summary(model_adj1_perch_sex) #Checking gender and perch interaction, does not meet threshold (p=0.802).

model_adj2_perch_sex <- glm(emr_thyroid_problem_fromothercolumns ~ log10(Result_P_ng_mL)*Gender + log10(Result_C_mg_dL) + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial")
summary(model_adj2_perch_sex) #Checking gender and perch interaction, does not meet threshold (p=0.581).

model_adj3_perch_sex <- glm(any_thyroid_Dummy_EMR_or_SR ~ log10(Result_P_ng_mL)*Gender +log10(Result_C_mg_dL) + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial")
summary(model_adj3_perch_sex) #Checking gender and perch interaction, does not meet threshold (p=0.726).


#model1_adj4 <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL)*age + log(Result_C_mg_dL) + Gender  + Ethnicity + as.factor(Site) + as.factor(Water_all), data=All_Data, family="binomial") 
#summary(model1_adj4) #int significant between age and perchlorate, but no biological justification for this.

#model1_adj4 <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL)*age + log(Result_C_mg_dL) + Gender  + Ethnicity + as.factor(Site) + as.factor(Water_all), data=subset(All_Data, All_Data$Site!=1), family="binomial") 
...
#model1_adj5 <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all) + as.factor(Income), data=All_Data, family="binomial")
#summary(model1_adj5) #Income sig. Need better groups. 

model1_adj5 <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all) + as.factor(Below_Pov), data=All_Data, family="binomial")
...
#What if I do division creatinine correction instead of adding as covariate?
#Also requested to include by reviewers (Nov 25, 2024)
model1_adj <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all), data=All_Data, family="binomial")
summary(model1_adj)

model1_adj8 <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL/Result_C_ng_mL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all), data=All_Data, family="binomial")
summary(model1_adj8)

#The CDC in their models just kept creatinine as a covariate, and so that's what I will do, too. That's also what Ben Blount recommended when we last spoke.

#Quick checks
#model1_adj <- glm(SR_EMR_Hypothyroid ~ log(Result_P_ng_mL)*Water_all +log(Result_C_mg_dL) + Gender + Ethnicity + Site + age, data=(subset(All_Data, All_Data$Site!=1))) #No interaction with perchlorate and water.

#model1_adj <- glm(SR_EMR_Hypothyroid ~ log10(Result_P_ng_mL) + age +log10(Result_C_mg_dL) + Gender + Ethnicity + Site + Water_all, data=All_Data) #Interaction between perchlorate and age. #Categorize age to see which age group is driving.

#Checking referent categories
levels(as.factor(All_Data$Site))
All_Data$Site <- C(All_Data$Site, contr.treatment, base=2)
levels(as.factor(All_Data$Water_all_revised))
levels(as.factor(All_Data$Ethnicity))
...
#1=Male, 2=Female
#Males
model1_adj_M <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=subset(All_Data, All_Data$Gender==1), family="binomial")
summary(model1_adj_M)
exp(confint(model1_adj_M))

#Females
model1_adj_F <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=subset(All_Data, All_Data$Gender==2), family="binomial")
summary(model1_adj_F)
exp(confint(model1_adj_F))

#Looking at covariate-adjusted vs corrected perchlorate/creatinine:
#What if I do division creatinine correction instead of adding as covariate?
model1_adj <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial")
summary(model1_adj)
exp(confint(model1_adj))

model1_adj_corrected <- glm(any_thyroid_problem_dummy ~ log(Result_P_ng_mL/Result_C_ng_mL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all), data=All_Data, family="binomial")
summary(model1_adj_corrected)
...
#1=Male, 2=Female
#Males
model2_adj_M <- glm(emr_thyroid_problem_fromothercolumns ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=subset(All_Data, All_Data$Gender==1), family="binomial")
summary(model2_adj_M)
exp(confint(model2_adj_M))

#Females
model2_adj_F <- glm(emr_thyroid_problem_fromothercolumns ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=subset(All_Data, All_Data$Gender==2), family="binomial")
summary(model2_adj_F)
exp(confint(model2_adj_F))

#Looking at covariate-adjusted vs corrected perchlorate/creatinine:
#What if I do division creatinine correction instead of adding as covariate?
model2_adj <- glm(emr_thyroid_problem_fromothercolumns ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial")
summary(model2_adj)
exp(confint(model2_adj))

model2_adj_corrected <- glm(emr_thyroid_problem_fromothercolumns ~ log(Result_P_ng_mL/Result_C_ng_mL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all), data=All_Data, family="binomial")
summary(model2_adj_corrected)
...
#1=Male, 2=Female
#Males
model3_adj_M <- glm(any_thyroid_Dummy_EMR_or_SR ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=subset(All_Data, All_Data$Gender==1), family="binomial")
summary(model3_adj_M)
exp(confint(model3_adj_M))

#Females
model3_adj_F <- glm(any_thyroid_Dummy_EMR_or_SR ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=subset(All_Data, All_Data$Gender==2), family="binomial")
summary(model3_adj_F)
exp(confint(model3_adj_F))

#Looking at covariate-adjusted vs corrected perchlorate/creatinine:
#What if I do division creatinine correction instead of adding as covariate?
model3_adj <- glm(any_thyroid_Dummy_EMR_or_SR ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all_revised), data=All_Data, family="binomial")
summary(model3_adj)
exp(confint(model3_adj))

model3_adj_corrected <- glm(any_thyroid_Dummy_EMR_or_SR ~ log(Result_P_ng_mL/Result_C_ng_mL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all), data=All_Data, family="binomial")
summary(model3_adj_corrected)
...
test_model <- glm(any_thyroid_Dummy_EMR_or_SR ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site) + as.factor(Water_all), data=subset(All_Data, All_Data$Site!=1), family="binomial")
summary(test_model)

#model3_adj <- glm(any_thyroid_Dummy_EMR_or_SR ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Gender*age + Ethnicity + Site + Water_all, data=All_Data)
#summary(model3_adj)
#exp(confint(model3_adj))
...
#model4_adj_withint <- glm(any_thyroid_Dummy_EMR_or_SR ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Gender*age + Ethnicity + Site + Water_all, data=All_Data)
#summary(model4_adj_withint)
...
#model4_adj <- glm(any_thyroid_Dummy_EMR_or_SR ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + Site + Water_all, data=All_Data)
#summary(model4_adj)
#exp(confint(model4_adj))
...
filtered_controls <- filtered_controls[!is.na(filtered_controls$bmi),] #n = 161 still
...
model_bmi_perch <- lm(log10(bmi)~log10(Result_P_ug_mL/Result_C_g_mL), data=filtered_controls)
summary(model_bmi_perch)

cor.test(log10(filtered_controls$bmi), log10(filtered_controls$Result_P_ug_mL/filtered_controls$Result_C_g_mL), method = 'pearson') 
...
```{r final_counts_pearsons}
All_Data_Perchlorate_Measured <- subset(All_Data, !is.na(All_Data$Result_P_ng_mL))
All_Data_Perchlorate_Measured_and_Creatinine <- subset(All_Data_Perchlorate_Measured, !is.na(All_Data_Perchlorate_Measured$Result_C_mg_dL))

#TSH
sum(!is.na(All_Data_Perchlorate_Measured$TSH)) #290
sum(!is.na(All_Data_Perchlorate_Measured_and_Creatinine$TSH)) #289

#FT3
sum(!is.na(All_Data_Perchlorate_Measured$fT3)) #294
sum(!is.na(All_Data_Perchlorate_Measured_and_Creatinine$fT3)) #293

#FT4
sum(!is.na(All_Data_Perchlorate_Measured$fT4)) #291
sum(!is.na(All_Data_Perchlorate_Measured_and_Creatinine$fT4)) #290

#TT3
sum(!is.na(All_Data_Perchlorate_Measured$TotalT3)) #291
sum(!is.na(All_Data_Perchlorate_Measured_and_Creatinine$TotalT3)) #290

#TT4
sum(!is.na(All_Data_Perchlorate_Measured$TotalT4)) #292
sum(!is.na(All_Data_Perchlorate_Measured_and_Creatinine$TotalT4)) #291

#Cortisol
sum(!is.na(All_Data_Perchlorate_Measured$Cortisol)) #288
sum(!is.na(All_Data_Perchlorate_Measured_and_Creatinine$Cortisol)) #287


#Counts:
#sum(!is.na(All_Data_Perchlorate_Measured$TSH)) is 290

All_Data_Perchlorate_Measured_TSH <- subset(All_Data_Perchlorate_Measured, !is.na(All_Data_Perchlorate_Measured$TSH))

sum(All_Data_Perchlorate_Measured_TSH$thyroid_med==0) #168
