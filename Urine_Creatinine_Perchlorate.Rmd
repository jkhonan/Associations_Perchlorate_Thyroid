...
model_hypo_adjusted_F <- glm(Hypo_D ~ log(Result_P_ng_mL) + log(Result_C_mg_dL) + Gender + age + Ethnicity + as.factor(Site)  + as.factor(Water_all), data=(All_Data), family="binomial") #adjusted for creatinine, site, water
